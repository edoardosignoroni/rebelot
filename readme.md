...
books.txt 
    from a portion of transcriptions of interviews on oral tradition and stories in the Bergamo area
    ...

proverbs.txt 
    from a website collecting Brescian proverbs and their explanations
    ...

news.txt
    articles on Brescian from Giornale di Brescia
    ...

socials.txt
    instagram posts from @bresciadice, english half-serious explanations of common idioms from Brescia
    ...
...
The data is provided in a de-contextualized, tokenized format (.vert). This transformation ensures the work is used for non-expressive, scientific purposes. By breaking the narrative flow and separating tokens, the dataset functions as a functional research tool rather than a substitute for the original copyrighted articles or social media posts. The original text has been tokenized, shuffled, and annotated. It does not constitute a "communication to the public" of the original works. All rights to the underlying original strings remain with the original creators. Personal identifiers have been removed or pseudonymized to protect the privacy of the original authors. Use of this data is grounded in the Text and Data Mining (TDM) exceptions for research (Art. 3, EU Directive 2019/790; Art. 70-ter Italian Law 633/1941).
